...
public class DegradeController {
    ...
    private DynamicRuleProvider<List<DegradeRuleEntity>> ruleNacosProvider;
    @Autowired
    @Qualifier("degradeRuleNacosPublisher")
    private DynamicRulePublisher<List<DegradeRuleEntity>> ruleNacosPublisher;
    ...
    private boolean publishRules(String app) {
        try {
            ...
            logger.warn(String.format("Publish degrade rules failed, app=%s", app), exception);
            return false;
        }
        return true;
    }
